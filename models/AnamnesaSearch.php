...
/**
 * AnamnesaSearch represents the model behind the search form of `app\models\Anamnesa`.
 */
class AnamnesaSearch extends Anamnesa
{
    ...
    public function rules()
    {
        return [
            ...
            [['jawaban1', 'jawaban2', 'jawaban3', 'jawaban4', 'jawaban5', 'jawaban6', 'jawaban7', 'jawaban8', 'no_daftar'], 'safe'],
        ];
    }
    ...
    {
        $query = Anamnesa::find()->orderBy('id_anamnesis DESC');
