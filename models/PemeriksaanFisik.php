 ...
 * @property string|null $tingkat_kesadaran_lainnya
 * @property string|null $kelenjar_getah_bening_lainnya
 * @property string|null $kepala_lainnya
 * @property string|null $hidung_lainnya
 * @property string|null $paru_jantung_lainnya
 * @property string|null $abdomen_lainnya
 * @property string|null $tulang_sendi_atas_lainnya
 * @property string|null $tulang_sendi_bawah_lainnya
 * @property string|null $otot_motorik_lainnya
 * @property string|null $fungsi_sensorik_autonom_lainnya
 */
class PemeriksaanFisik extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['gigi', 'kulit_lain', 'resume_kelainan', 'hasil_body_map', 'hasil_brief_survey', 'diagnosis_kerja', 'diagnosis_diferensial', 'kategori_kesehatan', 'mata_visus_dengan_koreksi_kiri', 'hemoroid', 'hemoroid_lainnya', 'hydrocele', 'varicocele', 'ulceral', 'gonorchoea', 'genitalia_lainnya', 'lingkar_kepala', 'tingkat_kesadaran_lainnya', 'kelenjar_getah_bening_lainnya', 'kepala_lainnya', 'hidung_lainnya', 'paru_jantung_lainnya', 'abdomen_lainnya', 'tulang_sendi_atas_lainnya', 'tulang_sendi_bawah_lainnya', 'otot_motorik_lainnya', 'fungsi_sensorik_autonom_lainnya'], 'string'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'tingkat_kesadaran_lainnya' => 'Tingkat Kesadaran Lainnya',
            'kelenjar_getah_bening_lainnya' => 'Kelenjar Getah Bening Lainnya',
            'kepala_lainnya' => 'Kepala Lainnya',
            'hidung_lainnya' => 'Hidung Lainnya',
            'paru_jantung_lainnya' => 'Paru Jantung Lainnya',
            'abdomen_lainnya' => 'Abdomen Lainnya',
            'tulang_sendi_atas_lainnya' => 'Tulang Sendi Atas Lainnya',
            'tulang_sendi_bawah_lainnya' => 'Tulang Sendi Bawah Lainnya',
            'otot_motorik_lainnya' => 'Otot Motorik Lainnya',
            'fungsi_sensorik_autonom_lainnya' => 'Fungsi Sensorik Autonom Lainnya',
        ];
    }
}
