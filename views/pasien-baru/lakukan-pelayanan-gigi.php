...
<div class="card card-body">
    <div class="mcu-spesialis-audiometri-form">
        ...
        <table class="table table-sm tabel-gigi">
            ...
            <tr>
                ...
                <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" colspan=3 align="left" valign=bottom>
                    <?= $form->field($model, 'g18')->textInput(['maxlength' => true,'class'=>'form-control form-control-sm'])->label(false) ?>
                </td>
                ...
                <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=bottom>
                    <?= $form->field($model, 'g38')->textInput(['maxlength' => true,'class'=>'form-control form-control-sm'])->label(false) ?>
                </td>
            </tr>
            <tr>
                ...
                <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" colspan=3 align="left" valign=bottom>
                    <?= $form->field($model, 'g17')->textInput(['maxlength' => true,'class'=>'form-control form-control-sm'])->label(false) ?>
                </td>
                ...
                <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=bottom>
                    <?= $form->field($model, 'g37')->textInput(['maxlength' => true,'class'=>'form-control form-control-sm'])->label(false) ?>
                </td>
            </tr>
            <tr>
                ...
                <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" colspan=3 align="left" valign=bottom>
                    <?= $form->field($model, 'g16')->textInput(['maxlength' => true,'class'=>'form-control form-control-sm'])->label(false) ?>
                </td>
                ...
                <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=bottom>
                    <?= $form->field($model, 'g36')->textInput(['maxlength' => true,'class'=>'form-control form-control-sm'])->label(false) ?>
                </td>
            </tr>
            <tr>
                ...
                <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" colspan=3 align="left" valign=bottom>
                    <?= $form->field($model, 'g15')->textInput(['maxlength' => true,'class'=>'form-control form-control-sm'])->label(false) ?>
                </td>
                ...
                <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=bottom>
                    <?= $form->field($model, 'g35')->textInput(['maxlength' => true,'class'=>'form-control form-control-sm'])->label(false) ?>
                </td>
            </tr>
            <tr>
                ...
                <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" colspan=3 align="left" valign=bottom>
                    <?= $form->field($model, 'g14')->textInput(['maxlength' => true,'class'=>'form-control form-control-sm'])->label(false) ?>
                </td>
                ...
                <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=bottom>
                    <?= $form->field($model, 'g34')->textInput(['maxlength' => true,'class'=>'form-control form-control-sm'])->label(false) ?>
                </td>
            </tr>
            <tr>
                ...
                <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" colspan=3 align="left" valign=bottom>
                    <?= $form->field($model, 'g13')->textInput(['maxlength' => true,'class'=>'form-control form-control-sm'])->label(false) ?>
                </td>
                ...
                <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=bottom>
                    <?= $form->field($model, 'g33')->textInput(['maxlength' => true,'class'=>'form-control form-control-sm'])->label(false) ?>
                </td>
            </tr>
            <tr>
                ...
                <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" colspan=3 align="left" valign=bottom>
                    <?= $form->field($model, 'g12')->textInput(['maxlength' => true,'class'=>'form-control form-control-sm'])->label(false) ?>
                </td>
                ...
                <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=bottom>
                    <?= $form->field($model, 'g32')->textInput(['maxlength' => true,'class'=>'form-control form-control-sm'])->label(false) ?>
                </td>
            </tr>
            <tr>
                ...
                <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" colspan=3 align="left" valign=bottom>
                    <?= $form->field($model, 'g11')->textInput(['maxlength' => true,'class'=>'form-control form-control-sm'])->label(false) ?>
                </td>
                ...
                <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=bottom>
                    <?= $form->field($model, 'g31')->textInput(['maxlength' => true,'class'=>'form-control form-control-sm'])->label(false) ?>
                </td>
            </tr>
            <tr>
                ...
                <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" colspan=3 align="left" valign=bottom>
                    <?= $form->field($model, 'g21')->textInput(['maxlength' => true,'class'=>'form-control form-control-sm'])->label(false) ?>
                </td>
                ...
                <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=bottom>
                    <?= $form->field($model, 'g41')->textInput(['maxlength' => true,'class'=>'form-control form-control-sm'])->label(false) ?>
                </td>
            </tr>
            <tr>
                ...
                <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" colspan=3 align="left" valign=bottom>
                    <?= $form->field($model, 'g22')->textInput(['maxlength' => true,'class'=>'form-control form-control-sm'])->label(false) ?>
                </td>
                ...
                <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=bottom>
                    <?= $form->field($model, 'g42')->textInput(['maxlength' => true,'class'=>'form-control form-control-sm'])->label(false) ?>
                </td>
            </tr>
            <tr>
                ...
                <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" colspan=3 align="left" valign=bottom>
                    <?= $form->field($model, 'g23')->textInput(['maxlength' => true,'class'=>'form-control form-control-sm'])->label(false) ?>
                </td>
                ...
                <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=bottom>
                    <?= $form->field($model, 'g43')->textInput(['maxlength' => true,'class'=>'form-control form-control-sm'])->label(false) ?>
                </td>
            </tr>
            <tr>
                ...
                <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" colspan=3 align="left" valign=bottom>
                    <?= $form->field($model, 'g24')->textInput(['maxlength' => true,'class'=>'form-control form-control-sm'])->label(false) ?>
                </td>
                ...
                <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=bottom>
                    <?= $form->field($model, 'g44')->textInput(['maxlength' => true,'class'=>'form-control form-control-sm'])->label(false) ?>
                </td>
            </tr>
            <tr>
                ...
                <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" colspan=3 align="left" valign=bottom>
                    <?= $form->field($model, 'g25')->textInput(['maxlength' => true,'class'=>'form-control form-control-sm'])->label(false) ?>
                </td>
                ...
                <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=bottom>
                    <?= $form->field($model, 'g45')->textInput(['maxlength' => true,'class'=>'form-control form-control-sm'])->label(false) ?>
                </td>
            </tr>
            <tr>
                ...
                <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" colspan=3 align="left" valign=bottom>
                    <?= $form->field($model, 'g26')->textInput(['maxlength' => true,'class'=>'form-control form-control-sm'])->label(false) ?>
                </td>
                ...
                <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=bottom>
                    <?= $form->field($model, 'g46')->textInput(['maxlength' => true,'class'=>'form-control form-control-sm'])->label(false) ?>
                </td>
            </tr>
            <tr>
                ...
                <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" colspan=3 align="left" valign=bottom>
                    <?= $form->field($model, 'g27')->textInput(['maxlength' => true,'class'=>'form-control form-control-sm'])->label(false) ?>
                </td>
                ...
                <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=bottom>
                    <?= $form->field($model, 'g47')->textInput(['maxlength' => true,'class'=>'form-control form-control-sm'])->label(false) ?>
                </td>
            </tr>
            <tr>
                ...
                <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" colspan=3 align="left" valign=bottom>
                    <?= $form->field($model, 'g28')->textInput(['maxlength' => true,'class'=>'form-control form-control-sm'])->label(false) ?>
                </td>
                ...
                <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=bottom>
                    <?= $form->field($model, 'g48')->textInput(['maxlength' => true,'class'=>'form-control form-control-sm'])->label(false) ?>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td align="left" valign=middle>:</td>
                <td style="border-right: 1px solid #000000" colspan=3 valign=middle>
                    <?= $form->field($model, 'lain_lain')->textInput(['maxlength' => true,'class'=>'form-control form-control-sm'])->label(false) ?>
                </td>
            </tr>
            <tr>
        ...
        <div class="form-group">
            ...
            if (!$model->isNewRecord)
                echo Html::a('<i class="far fa-file-excel"></i> Cetak Hard Copy', ['/spesialis-gigi/cetak', 'no_rm' => $id, 'no_daftar' => $no_register], ['target' => 'blank', 'data-pjax' => 0, 'class' => 'btn btn-info', 'style' => 'margin-left: 10px;']);
            ?>
        </div>
        <?php
        Pjax::end();
...
$this->registerJs($this->render('periksa-gigi.js'), View::POS_END);
