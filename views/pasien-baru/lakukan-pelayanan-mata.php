...
<div class="card card-body">
    <style type="text/css">
        #form-spesialis-mata .col-form-label {
            font-size: smaller;
        }

        #form-spesialis-mata .form-group {
    ...
    <div class="mcu-spesialis-audiometri-form">
        ...
        <div class="form-group">
            ...
            if (!$model->isNewRecord)
                echo Html::a('<i class="far fa-file-excel"></i> Cetak Hard Copy', ['/spesialis-mata/cetak', 'no_rm' => $id, 'no_daftar' => $no_register], ['target' => 'blank', 'data-pjax' => 0, 'class' => 'btn btn-info', 'style' => 'margin-left: 10px;']);
            ?>
        </div>
        <?php
        Pjax::end();
...
$this->registerJs($this->render('periksa-mata.js'), View::POS_END);
