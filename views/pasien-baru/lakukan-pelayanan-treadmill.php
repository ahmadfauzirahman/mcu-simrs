    ...
    <div class="mcu-spesialis-audiometri-form">
        ...
        <table class="table table-sm" style="width: 100%;">
            <tbody>
                <tr>
                    ...
                    <td style="width: 1%;">:</td>
                    <td>
                        <?= $form->field($model, 'permintaan')->textInput(['placeholder' => 'Atas Permintaan','class'=>'form-control form-control-sm'])->label(false) ?>
                    </td>
                </tr>
            </tbody>
        </table>
        ...
        <table class="table table-sm tabel-treadmill" style="width: 100%;">
            <tbody>
                <tr>
                    ...
                    <td style="width: 1%;">:</td>
                    <td style="width: 80%;">
                        <?= $form->field($model, 'metode')->textInput(['class'=>'form-control form-control-sm','placeholder'=>'Metode'])->label(false) ?>
                    </td>
                </tr>
                <tr>
                    <td>Lama Latihan</td>
                    <td>:</td>
                    <td>
                        <?= $form->field($model, 'lama_latihan')->textInput(['class'=>'form-control form-control-sm','placeholder'=>'Lama Latihan'])->label(false) ?>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>:</td>
                    <td>
                        <?= $form->field($model, 'test_dihentikan_karena')->textInput(['class'=>'form-control form-control-sm','placeholder'=>'Test Dihentikan Karena'])->label(false) ?>
                    </td>
                </tr>
                <tr>
                    <td>DJ Maksimal</td>
                    <td>:</td>
                    <td>
                        <?= $form->field($model, 'dj_maksimal')->textInput(['class'=>'form-control form-control-sm','placeholder'=>'DJ Maksimal'])->label(false) ?>
                    </td>
                </tr>
                <tr>
                    <td>TD Awal</td>
                    <td>:</td>
                    <td>
                        <?= $form->field($model, 'td_minimal')->textInput(['class'=>'form-control form-control-sm','placeholder'=>'TD Awal'])->label(false) ?>
                    </td>
                </tr>
                <tr>
                    <td>TD Maksimal</td>
                    <td>:</td>
                    <td>
                        <?= $form->field($model, 'td_maksimal')->textInput(['class'=>'form-control form-control-sm','placeholder'=>'TD Maksimal'])->label(false) ?>
                    </td>
                </tr>
                <tr>
                    <td>EKG</td>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>
                        <?= $form->field($model, 'ekg_istirahat')->textInput(['class'=>'form-control form-control-sm','placeholder'=>'Istirahat'])->label(false) ?>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>:</td>
                    <td>
                        <?= $form->field($model, 'ekg_latihan')->textInput(['class'=>'form-control form-control-sm','placeholder'=>'Latihan'])->label(false) ?>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>:</td>
                    <td>
                        <?= $form->field($model, 'ekg_pemulihan')->textInput(['class'=>'form-control form-control-sm','placeholder'=>'Pemulihan'])->label(false) ?>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>
                        <?= $form->field($model, 'kapasitas_aerobik')->textInput(['class'=>'form-control form-control-sm','placeholder'=>'Kapasitas Aerobik'])->label(false) ?>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="input-group">
                            ...
                            <input value="<?= (!in_array($model->respon_iskemik, $respon_iskemik_option)) ? $model->respon_iskemik : null ?>" type="text" id="McuSpesialisTreadmill_respon_iskemik_2_teks" style="width: 50px;" class="form-control form-control-sm">
                        </div>
                    </td>
                </tr>
                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="border-top: 1px solid #ffffff; width: 100%; padding-left: 3% !important;">
                                        <div class="input-group">
                                            ...
                                            <input value="<?= (!in_array($model->anjuran, $anjuran_option)) ? $model->anjuran : null ?>" type="text" id="McuSpesialisTreadmill_anjuran_3_teks" style="width: 50px;" class="form-control form-control-sm">
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
        ...
        <div class="div-penata" style="display: <?= $displayPenata ?>;">
            ...
            <div class="form-group" style="margin-top: 5px;">
                ...
                if (!$model->isNewRecord)
                    echo Html::submitButton('Simpan', ['class' => 'btn btn-success btn-sm']);
...
$this->registerJs($this->render('periksa-treadmill.js'), View::POS_END);
